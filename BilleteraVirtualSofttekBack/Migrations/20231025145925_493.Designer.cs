            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 366, DateTimeKind.Local).AddTicks(2556),
                            Email = "1@1.com",
                            Name = "random",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 366, DateTimeKind.Local).AddTicks(2660),
                            Email = "2@2.com",
                            Name = "random",
                            Password = "389aec82d3ce947fd1ba75e52b2b49d5e7ffcebe7d8e059db3bb8c49594d0bbf",
                            Role = 2
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.CryptoAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 1000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 370, DateTimeKind.Local).AddTicks(4662),
                            Type = 3,
                            UUID = new Guid("7410ef44-4523-464f-a415-ed7e36f217fb")
                        },
                        new
                        {
                            Id = 6,
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 370, DateTimeKind.Local).AddTicks(4668),
                            Type = 3,
                            UUID = new Guid("2f087c93-f82b-4d4a-9369-506f67581234")
                        });
                });
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.DollarAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 369, DateTimeKind.Local).AddTicks(266),
                            Type = 2,
                            AccountNumber = 2,
                        ...
                        new
                        {
                            ...
                            Balance = 4000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 369, DateTimeKind.Local).AddTicks(270),
                            Type = 2,
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.PesoAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 1000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 367, DateTimeKind.Local).AddTicks(6950),
                            Type = 1,
                        ...
                        new
                        {
                            ...
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 11, 59, 25, 367, DateTimeKind.Local).AddTicks(6954),
                            Type = 1,
