...
namespace BilleteraVirtualSofttekBack.Migrations
{
    ...
    [Migration("20231025133103_487892")]
    partial class _487892
    {
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 258, DateTimeKind.Local).AddTicks(3994),
                            Email = "1@1.com",
                            Name = "random",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 258, DateTimeKind.Local).AddTicks(4070),
                            Email = "2@2.com",
                            Name = "random",
                            Password = "389aec82d3ce947fd1ba75e52b2b49d5e7ffcebe7d8e059db3bb8c49594d0bbf",
                            Role = 2
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.CryptoAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 1000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 262, DateTimeKind.Local).AddTicks(4014),
                            Type = 3,
                            UUID = new Guid("955760dc-626e-46a2-9ebd-adb805a4a317")
                        },
                        new
                        {
                            Id = 6,
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 262, DateTimeKind.Local).AddTicks(4037),
                            Type = 3,
                            UUID = new Guid("d7c77b5e-8c6a-4d09-bf43-9cba3dc74d7a")
                        });
                });
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.DollarAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 261, DateTimeKind.Local).AddTicks(3320),
                            Type = 2,
                            AccountNumber = 2,
                        ...
                        new
                        {
                            ...
                            Balance = 4000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 261, DateTimeKind.Local).AddTicks(3325),
                            Type = 2,
            ...
            modelBuilder.Entity("BilleteraVirtualSofttekBack.Models.Entities.Accounts.PesoAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 1000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 259, DateTimeKind.Local).AddTicks(9498),
                            Type = 1,
                        ...
                        new
                        {
                            ...
                            Balance = 2000m,
                            ClientId = 1,
                            CreatedDate = new DateTime(2023, 10, 25, 10, 31, 3, 259, DateTimeKind.Local).AddTicks(9502),
                            Type = 1,
